        ...
        >
            <div class="scroll-wrapper">
                <div class="review-content" v-if="reviewDetail.author">
                    ...
                    <div class="author">
                        <div class="avatar">
                            <img :src="reviewDetail.author.avatar" width="36" height="36">
                        </div>
                        <div class="info">
                            <h2>
                                <span class="name">{{reviewDetail.author.name}}</span>
                            的影评</h2>
                            <span class="date">{{reviewDetail.created_at.split(' ')[0]}}</span>
                            <star 
                                :size="24" 
                                :score="reviewDetail.rating.value * 2"
                            ></star>
                        </div>
                    </div>
                    <p class="desc">{{reviewDetail.content}}</p>
                    <div class="copyright">
            ...
            <loadmore :fullScreen="fullScreen" v-if="!reviewDetail.author"></loadmore>
        </scroll>
    </div>
</template>
