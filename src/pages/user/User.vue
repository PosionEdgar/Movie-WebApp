<template>
  <div class="user-center">
    <div class="user">
      <div class="avatar">
        <img src="@/assets/images/avatar.jpg" width="60" height="60"/>
      </div>
...
<script>
	...
	import CelebrityList from 'pages/celebrity-list/celebrity-list'
	...
	export default {
		...
		methods: {
			...
			switchTab(index) {
				...
				this.$nextTick(() => {
					this.$refs.scroll.scrollTo(90, 90);
					this.$refs.scroll.refresh();
				});
